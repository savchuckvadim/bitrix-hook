...
const UiButtons = () => {
  ...
  //meta title
  document.title = "Buttons | Skote React + Laravel 10 Admin And Dashboard Template";
            ...
            <Col xl="6">
              <Card>
                <CardBody>
                  ...
                  <div>
                    <button className="btn btn-primary" style={{ '--bs-btn-padding-y': '.25rem', '--bs-btn-padding-x': '.5rem', '--bs-btn-font-size': '.75rem' }}>
                      Custom button
                    </button>
                  </div>
                </CardBody>
        ...
        <Col xl="6">
          <Card>
            <CardBody>
              ...
              <div>
                <Link to="#" className="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style={{ '--bs-focus-ring-color': 'rgba(var(--bs-success-rgb), .25)' }}>
                  Green focus ring
                </Link>
              </div>
            </CardBody>
