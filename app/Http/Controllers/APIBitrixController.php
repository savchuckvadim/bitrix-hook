...
//TODO оставить только общие вспомогательные методы
// по типу getRsponse
// методы 
// initialCold
// createColdTask
// createTask
// failTask
// ........... вынести в BitrixHookController 

// методы создающие или изменяющие сущности вынести в BitrixGeneralService
// в апиконтроллерах методы связанные с дополнительной помогающей обработкой respons и реквест
// в других контроллерах непосредственно принимающие и перенаправляющие в логику методы


// create cold task перенес в hook controller
