...
class MColdController extends Controller
{
    ...
    public function crm()
    {
        ...
        try {
            ...
            set_time_limit(0);
            $jsonFilePath = storage_path('app/public/clients/clients_events_data_1.json');
            ...
            if (!empty($commands)) {
                ...
                foreach ($chunks as $index => $chunk) {
                    $chunkJsonData = json_encode($chunk, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
                    $chunkFilePath = $storagePath . 'resultClients_part' . ($index + 1) . '.json';
