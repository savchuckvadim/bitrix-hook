...
class BitrixGeneralService
{
    ...
    static function createSmartItem(
        ...
        $createdId,
        $smart, //april smart data
        $lastCallDateField,  // ай ди поля дата звонка
        $lastCallDateFieldCold, // ай ди поля дата холодного звонка
        $callThemeField,        // ай ди поля дата звонка
        $callThemeFieldCold,// ай ди поля тема холодного звонкаdeadline
        $deadline,           // крайний срок
        $nameOfCall,          //тема, название звонка
        $typeOfCall,          //тип звонка cold, warm, other
        $commentOfCall       // комментарий
    ) {
    ...
    protected function getCurrentSmartFields($hook, $smart)
    {
    ...
    // company
    protected function updateCompanyCold($hook, $responsibleId, $companyId)
    {
